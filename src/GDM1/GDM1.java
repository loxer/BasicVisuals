...
public class GDM1 implements PlugIn {
    ...
    final static String[] choices = { "Schwarzes Bild", "Gelbes Bild", "Vertikaler Schwarz/Weiss Verlauf",
            ...
            "Horrizontaler Schwarz/Weiss/Schwarz Verlauf", "Horiz. Schwarz/Rot vert. Schwarz/Blau Verlauf", "Franz̦sische Flagge", "Bahamische Flagge",
            "Tschechiche Flagge", "Bangladeschische Flagge", "Japanische Flagge", "Japanische Flagge mit weichen Kanten" };
    ...
    public void generateCourseHorrizontalSWS(int width, int height, int[] pixels){
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 0; x < width; x++) {
                ...
                if (x <= halfWidth ) {
                    r = g = b = (int) ((float) x / halfWidth * 255); // calculates the grade of grey by the position of the pixel
//					System.out.println(r + " " + g + " " + b);
                }
                ...
                if (x > halfWidth) {
                    ...
                    r = g = b = (int) ((float) ((width - x) / halfWidth * 255)); // calculates the grade of grey by the position of the pixel || value of the position must go down, because the grade should get darker
//					System.out.println(r + " " + g + " " + b);
                }
